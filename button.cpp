...
void Button::onClick(QGraphicsSceneMouseEvent *ev)
{
    if (type == 1)
    {
        ...
        ImageTransformBuilder()
            ...
            .setImage(":/pictures/images/menu/StopButton.png")
            .setAlignment(Qt::AlignCenter)
        ...
        ImageTransformBuilder()
            ...
            .setImage(":/pictures/images/menu/1-Score.png")
            .setAlignment(Qt::AlignCenter)
        ...
        ImageTransformBuilder()
            ...
            .setImage(":/pictures/images/menu/ScoreBoard.png")
            .setAlignment(Qt::AlignCenter)
        ...
        ImageTransformBuilder()
            ...
            .setImage(":/pictures/images/menu/2-Score.png")
            .setAlignment(Qt::AlignCenter)
        ...
        ImageTransformBuilder()
            ...
            .setImage(":/pictures/images/menu/3-Score.png")
            .setAlignment(Qt::AlignCenter)
        ...
        ImageTransformBuilder()
            ...
            .setImage(":/pictures/images/menu/4-Score.png")
            .setAlignment(Qt::AlignCenter)
    ...
    else if (type == 2)
    {
        if (!clicked)
        {
            ...
            ImageTransformBuilder()
                ...
                .setImage(":/pictures/images/menu/Description.png")
                .setAlignment(Qt::AlignCenter)
                .addToGameObject(des);
            Des = des;
